...
<template>
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Add drink</h2>
        </template>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12 pb-20">
            <div class="w-full  px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
                ...
                <header>
                    <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Add drink here</h2>

                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Please use this form to add a drink.
                    </p>
                </header>
